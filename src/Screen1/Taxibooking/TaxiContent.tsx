  ...
  useEffect(() => {
    const requestLocation = async () => {
      ...
      if (propCurrentLocation) {
        ...
        // ✅ FIXED: Don't automatically set pickup location
...
//               {/* ✅ CRITICAL: Driver marker - Always show if driverLocation exists */}
//               {driverLocation && (
//                 <Marker 
//                   coordinate={driverLocation} 
//                   title="Driver"
...
//                 >
//                   <View style={styles.driverMarkerContainer}>
//                     <View style={[styles.vehicleIconContainer, { backgroundColor: rideStatus === "onTheWay" || rideStatus === "arrived" || rideStatus === "started" ? '#FF6B00' : '#4CAF50' }]}>
//                       {renderVehicleIcon(selectedRideType as 'bike' | 'taxi' | 'port', 24, '#FFFFFF')}
//                     </View>
//                   </View>
//                 </Marker>
//               )}
...
//                 >
//                   <View style={styles.driverMarkerContainer}>
//                     <View style={[styles.vehicleIconContainer, { backgroundColor: '#4CAF50' }]}>
//                       {renderVehicleIcon(driver.vehicleType as 'bike' | 'taxi' | 'port', 24, '#FFFFFF')}
//                     </View>
//                   </View>
//                 </Marker>
//               ))}
